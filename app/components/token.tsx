...
const CoinToken = ({cmc_rank, price, percent_change_24h, symbol, market_cap_dominance}: CoinTokenProps) => {
    ...
    return (
        <div className='flex px-8 py-1 bg-[#2F2E2E] mb-5 text-slate-50 text-xs'>
            ...
            <div className='flex flex-row justify-start gap-2 items-center w-1/4'>
                <Image
                    className='order-1'
                    src={`/images/svg/${symbol}.svg`}
                    width={32}
                    height={32}
                    alt='CUR'
                />
                <div className='order-2 my-auto'>
                    ...
                    <p className='order-2 text-[#707070]'>{market_cap_dominance}</p></div>
            </div>
